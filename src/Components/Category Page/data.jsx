...
export const subCategories = {
    [categories[0]]: [
        "Textbooks", "Power Tools", "Music Instruments", 
        "Luggage", "Camping Gear", "Construction Equipments", "Farming Equipments",
        "Ladder", "Office Space", "Storage Space", "Photography / Videography",
    ],
